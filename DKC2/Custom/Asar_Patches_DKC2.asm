; Note: Put your custom routine/data macros, references to them, and defines in this file from within the DKC2_InsertIntegratedPatches and DKC2_ApplyPatchesPostAssembly macros below.
; By doing this:
...
macro DKC2_InsertIntegratedPatches()
...
macro DKC2_ApplyPatchesPostAssembly()
